export const projectData = [
  ...
  },
  {
    ...
    projectDescription:
      "The Ancoats Post Backend API is a robust foundation for managing news articles and user comments, built to be scalable and reliable. This project was developed as part of my bootcamp journey, showcasing my proficiency in backend development.",
    projectFeatureTitle1: "Efficient Routing: ",
    projectFeature1:
      "With Express.js, routes and handlers are meticulously defined for each endpoint, enabling the efficient retrieval of data in a structured and organized manner. ",
    ...
    projectFeature3:
      "By adopting a TDD approach, the API was developed with a focus on robust functionality from the outset, minimizing potential issues. ",
